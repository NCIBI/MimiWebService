...
<%
	...
	MimiDocument highlightGene = null;
	if (geneid != null)
	{
		for (MimiDocument gene: externalGeneList) {
			if (gene.geneid == geneid.intValue())
				highlightGene = gene;
		}
	}
...
{
%>
<b>More:</b> Click <a href="document-details-page-v2-extension-front.jsp?<%= request.getQueryString() %>">here</a>
to see details of the genes listed below in a table that can be downloaded.
