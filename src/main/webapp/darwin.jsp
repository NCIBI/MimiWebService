...
<%
    ...
    if (bb == null)
    {
        ...
        bb.addBreadcrumb("Home", WebApp.constructWebAppPath(request, "darwin/darwin.jsp")) ;
    ...
    if (searchCrumb == null)
    {
        ...
        searchCrumb.addBreadcrumb("Searches", 
            WebApp.constructWebAppPath(request, "darwin/darwin.jsp")) ;
...
<html>
   <head>
      ...
      <script type='text/javascript' src='<c:url value="/dwr/interface/DisplayTagService.js"/>'></script>
       ...
       <link rel="stylesheet" type="text/css" href='<c:url value="/css/displaytagdarwin.css"/>' />
...
%>            	</select>
    ...
    <div id="search-gene-type3">
        <p>Search: <br>
        <input name="qtype" value="gene" type="radio" checked><strong>Genes</strong><br>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;example: <em>brca2</em><br>
        <input name="qtype" value="mesh" type="radio" ><strong>Concepts</strong><br>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;example:<em> "diabetes"</em><br>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;example:<em> "cell cycle"</em><br>
        <input name="qtype" value="gene" type="radio" ><strong>Gene List</strong><br>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;example:<em> "prostatic neoplasms"</em><br>
        <input name="qtype" value="gene" type="radio" ><strong>Concept List</strong><br>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;example:<em> "prostatic neoplasms"</em><br>
        <input name="qtype" value="gene" type="radio" ><strong>Genes and/or Concepts</strong><br>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;example:<em> "prostatic neoplasms"</em> AND AR
        </p>
        <p>
            <br> <br> <br> <br> 
        </p>
    ...
    <div id="search-gene-type2">
        <p>Output: <br>
        <input type="checkbox" name="checkbox" id="checkbox"><strong>Genes</strong><br>
        <input type="checkbox" name="checkbox2" id="checkbox2"><strong>Concepts</strong><br>
        <input type="checkbox" name="checkbox3" id="checkbox3"><strong>Interactions</strong><br>
        <input type="checkbox" name="checkbox4" id="checkbox4"><strong>Metabolites</strong><br>
        <input type="checkbox" name="checkbox5" id="checkbox5"><strong>Literature</strong><br>
        <input type="checkbox" name="checkbox6" id="checkbox6"><strong>Pathways</strong>
        </p>
        <p>
            <br> <br> <br> <br>
        </p>
