...
if (symbolArray != null) 
{
	escapedQueryText = FileUploadHelper2.buildQuery(symbolArray, 
        SymbolList.parseEnum(typeselection), taxid);
    session.setAttribute("symbolArray", symbolArray);
    session.setAttribute("query", escapedQueryText);
}
